...
// include: /var/folders/zg/t3pnypsj45j3r3ygmj6nz1sh0000gn/T/tmpoa__7lpq.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'gatherfield_web.data';
      var REMOTE_PACKAGE_BASE = 'gatherfield_web.data';
...
Module['FS_createPath']("/", "assets", true, true);
    ...
    for (var file of metadata['files']) {
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency'](`fp ${name}`);
          ...
          Module['removeRunDependency']('datafile_gatherfield_web.data');
      }
      Module['addRunDependency']('datafile_gatherfield_web.data');
    ...
    loadPackage({"files": [{"filename": "/assets/basictiles.aseprite", "start": 0, "end": 1965}, {"filename": "/assets/basictiles.json", "start": 1965, "end": 6342}, {"filename": "/assets/basictiles.png", "start": 6342, "end": 8966}], "remote_package_size": 8966});

  })();

// end include: /var/folders/zg/t3pnypsj45j3r3ygmj6nz1sh0000gn/T/tmpoa__7lpq.js
// include: /var/folders/zg/t3pnypsj45j3r3ygmj6nz1sh0000gn/T/tmpskgo5bvf.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /var/folders/zg/t3pnypsj45j3r3ygmj6nz1sh0000gn/T/tmpskgo5bvf.js
// include: /opt/homebrew/Cellar/emscripten/5.0.2/libexec/src/emrun_prejs.js
/**
 * @license
...
// end include: /opt/homebrew/Cellar/emscripten/5.0.2/libexec/src/emrun_prejs.js
// include: /var/folders/zg/t3pnypsj45j3r3ygmj6nz1sh0000gn/T/tmpujb6evhn.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /var/folders/zg/t3pnypsj45j3r3ygmj6nz1sh0000gn/T/tmpujb6evhn.js
...
function findWasmBinary() {
  return locateFile('gatherfield_web.wasm');
}
...
var ASM_CONSTS = {
  93470: () => { if (document.fullscreenElement) return 1; },  
 93516: () => { return Module.canvas.width; },  
 93548: () => { return parseInt(Module.canvas.style.width); },  
 93596: () => { document.exitFullscreen(); },  
 93623: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 93695: () => { if (document.fullscreenElement) return 1; },  
 93741: () => { return Module.canvas.width; },  
 93773: () => { return screen.width; },  
 93798: () => { document.exitFullscreen(); },  
 93825: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 94019: () => { return window.innerWidth; },  
 94045: () => { return window.innerHeight; },  
 94072: () => { if (document.fullscreenElement) return 1; },  
 94118: () => { return Module.canvas.width; },  
 94150: () => { return parseInt(Module.canvas.style.width); },  
 94198: () => { if (document.fullscreenElement) return 1; },  
 94244: () => { return Module.canvas.width; },  
 94276: () => { return screen.width; },  
 94301: () => { return window.innerWidth; },  
 94327: () => { return window.innerHeight; },  
 94354: () => { if (document.fullscreenElement) return 1; },  
 94400: () => { return Module.canvas.width; },  
 94432: () => { return screen.width; },  
 94457: () => { document.exitFullscreen(); },  
 94484: () => { if (document.fullscreenElement) return 1; },  
 94530: () => { return Module.canvas.width; },  
 94562: () => { return parseInt(Module.canvas.style.width); },  
 94610: () => { document.exitFullscreen(); },  
 94637: ($0) => { Module.canvas.style.opacity = $0; },  
 94675: () => { return screen.width; },  
 94700: () => { return screen.height; },  
 94726: () => { return window.screenX; },  
 94753: () => { return window.screenY; },  
 94780: () => { return window.devicePixelRatio; },  
 94816: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 94869: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 94920: () => { Module.canvas.style.cursor = 'none'; },  
 94957: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 95213: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 95264: () => { if (document.pointerLockElement) return 1; },  
 95311: () => { if (document.fullscreenElement) return 1; },  
 95357: () => { return window.innerWidth; },  
 95383: () => { return window.innerHeight; }
};
...
// include: /opt/homebrew/Cellar/emscripten/5.0.2/libexec/src/emrun_postjs.js
/**
 * @license
 * Copyright 2013 The Emscripten Authors
 * SPDX-License-Identifier: MIT
...
// end include: /opt/homebrew/Cellar/emscripten/5.0.2/libexec/src/emrun_postjs.js
