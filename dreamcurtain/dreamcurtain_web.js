...
// include: /var/folders/zg/t3pnypsj45j3r3ygmj6nz1sh0000gn/T/tmpmyuk4bb7.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'dreamcurtain_web.data';
      var REMOTE_PACKAGE_BASE = 'dreamcurtain_web.data';
...
Module['FS_createPath']("/assets/audio", "sfx", true, true);
...
Module['FS_createPath']("/assets", "ui", true, true);
    ...
    for (var file of metadata['files']) {
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency'](`fp ${name}`);
          ...
          Module['removeRunDependency']('datafile_dreamcurtain_web.data');
      }
      Module['addRunDependency']('datafile_dreamcurtain_web.data');
    ...
    loadPackage({"files": [{"filename": "/assets/audio/bgm/main_loop.wav", "start": 0, "end": 5644880}, {"filename": "/assets/audio/enemy_hit_loop2.wav", "start": 5644880, "end": 6048086}, {"filename": "/assets/audio/sfx/boss_death.wav", "start": 6048086, "end": 6471526}, {"filename": "/assets/audio/sfx/countdown_0.wav", "start": 6471526, "end": 6542370}, {"filename": "/assets/audio/sfx/countdown_1.wav", "start": 6542370, "end": 6606014}, {"filename": "/assets/audio/sfx/countdown_10.wav", "start": 6606014, "end": 6673258}, {"filename": "/assets/audio/sfx/countdown_2.wav", "start": 6673258, "end": 6739302}, {"filename": "/assets/audio/sfx/countdown_3.wav", "start": 6739302, "end": 6807746}, {"filename": "/assets/audio/sfx/countdown_4.wav", "start": 6807746, "end": 6873790}, {"filename": "/assets/audio/sfx/countdown_5.wav", "start": 6873790, "end": 6943434}, {"filename": "/assets/audio/sfx/countdown_6.wav", "start": 6943434, "end": 7007078}, {"filename": "/assets/audio/sfx/countdown_7.wav", "start": 7007078, "end": 7079122}, {"filename": "/assets/audio/sfx/countdown_8.wav", "start": 7079122, "end": 7141566}, {"filename": "/assets/audio/sfx/countdown_9.wav", "start": 7141566, "end": 7217210}, {"filename": "/assets/audio/sfx/emitter_fire.wav", "start": 7217210, "end": 7245514}, {"filename": "/assets/audio/sfx/enemy_death.wav", "start": 7245514, "end": 7351434}, {"filename": "/assets/audio/sfx/enemy_hit_loop.wav", "start": 7351434, "end": 7450298}, {"filename": "/assets/audio/sfx/enemy_hit_loop2_loop.wav", "start": 7450298, "end": 7541540}, {"filename": "/assets/audio/sfx/player_field_activate.wav", "start": 7541540, "end": 7788580}, {"filename": "/assets/sprites/emitter_marker.png", "start": 7788580, "end": 7790080}, {"filename": "/assets/sprites/player_shot_atlas.png", "start": 7790080, "end": 7790769}, {"filename": "/assets/sprites/projectile_atlas.png", "start": 7790769, "end": 7815217}, {"filename": "/assets/ui/cabinet_overlay_master.png", "start": 7815217, "end": 8076807}], "remote_package_size": 8076807});

  })();

// end include: /var/folders/zg/t3pnypsj45j3r3ygmj6nz1sh0000gn/T/tmpmyuk4bb7.js
// include: /var/folders/zg/t3pnypsj45j3r3ygmj6nz1sh0000gn/T/tmphxiixbsd.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /var/folders/zg/t3pnypsj45j3r3ygmj6nz1sh0000gn/T/tmphxiixbsd.js
// include: /var/folders/zg/t3pnypsj45j3r3ygmj6nz1sh0000gn/T/tmp_eqswci5.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /var/folders/zg/t3pnypsj45j3r3ygmj6nz1sh0000gn/T/tmp_eqswci5.js
...
function findWasmBinary() {
  return locateFile('dreamcurtain_web.wasm');
}
...
var ASM_CONSTS = {
  120984: () => { if (document.fullscreenElement) return 1; },  
 121030: () => { return document.getElementById('canvas').width; },  
 121082: () => { return parseInt(document.getElementById('canvas').style.width); },  
 121150: () => { document.exitFullscreen(); },  
 121177: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 121250: () => { if (document.fullscreenElement) return 1; },  
 121296: () => { return document.getElementById('canvas').width; },  
 121348: () => { return screen.width; },  
 121373: () => { document.exitFullscreen(); },  
 121400: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 121533: () => { return window.innerWidth; },  
 121559: () => { return window.innerHeight; },  
 121586: () => { if (document.fullscreenElement) return 1; },  
 121632: () => { return document.getElementById('canvas').width; },  
 121684: () => { return parseInt(document.getElementById('canvas').style.width); },  
 121752: () => { if (document.fullscreenElement) return 1; },  
 121798: () => { return document.getElementById('canvas').width; },  
 121850: () => { return screen.width; },  
 121875: () => { return window.innerWidth; },  
 121901: () => { return window.innerHeight; },  
 121928: () => { if (document.fullscreenElement) return 1; },  
 121974: () => { return document.getElementById('canvas').width; },  
 122026: () => { return screen.width; },  
 122051: () => { document.exitFullscreen(); },  
 122078: () => { if (document.fullscreenElement) return 1; },  
 122124: () => { return document.getElementById('canvas').width; },  
 122176: () => { return parseInt(document.getElementById('canvas').style.width); },  
 122244: () => { document.exitFullscreen(); },  
 122271: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 122329: () => { return screen.width; },  
 122354: () => { return screen.height; },  
 122380: () => { return window.screenX; },  
 122407: () => { return window.screenY; },  
 122434: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 122487: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 122558: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 122615: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 122871: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 122942: () => { if (document.fullscreenElement) return 1; },  
 122988: () => { return window.innerWidth; },  
 123014: () => { return window.innerHeight; },  
 123041: () => { if (document.pointerLockElement) return 1; }
};
